...
def objective(trial, encoder_params, dataset_params, optimization_params):
    ...
    vicreg_only = optimization_params['vicreg_only']
...
if __name__=='__main__':
    ...
    optimization_params['contrastive_atttention_vicreg'] = False
    optimization_params['vicreg_only'] = True
    ...
    encoder_params["learning_rate_enc"] = [0.00001,0.01]
