...
def objective(trial, data, encoder_params, dataset_params, optimization_params, checkpoint):
...
if __name__=='__main__':
    ...
    # python optuna_encoder.py --dataset mnist --n_trials 3

    parser = argparse.ArgumentParser()
    parser.add_argument('--dataset',type=str,default='mnist')
    parser.add_argument('--n_trials',type=int,default=10)
    parser.add_argument('--num_samples_dist',type=int,default=100_00)
    parser.add_argument('--num_samples_train',type=int,default=10_00)
    ...
    if dataset=='mnist':
        ...
        data_path = Path('../../../sandbox/data/ember/top_k/ember_top_10.csv')
        data_class = EmberDataset

    elif dataset=='sorel':
        data_path = Path('../../../sandbox/data/sorel/top_k/sorel_subset.csv')
        data_class = SorelDataset

    elif dataset=='ccc':
        data_path = Path('../../../sandbox/data/MalwareDatasets/MalwareDatasets/CCCS-CIC-AndMal2020/total/cccs_cic_andmal2020.csv')
        data_class = CCCS
        ...
        data_path = Path('../../../sandbox/data/MalwareDatasets/MalwareDatasets/CICMalDroid2020/total/feature_vectors_syscalls_frequency_5_Cat.csv')
        data_class = SysCalls

    elif dataset=='syscallsbinders':
        data_path = Path('../../../sandbox/data/MalwareDatasets/MalwareDatasets/CICMalDroid2020/total/feature_vectors_syscallsbinders_frequency_5_Cat.csv')
    ...
    study.optimize(wrapped_objective(data, encoder_params, dataset_params, optimization_params, checkpoint), n_trials=n_trials)
    ...
    best_params = study.best_params
    embeddings,labels_true = encode(data,dataset_params,checkpoint)
